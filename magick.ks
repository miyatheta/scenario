...
[glink color="black" size="18" x=&f.pos_Comand_btn_x2 y="400" text="空蝉(CT10)" target="*空蝉"]
[glink color="black" size="18" x=&f.pos_Comand_btn_x2 y="450" text="戻る" storage="&f.returnStr" target="&f.returnTag"]
[s]
