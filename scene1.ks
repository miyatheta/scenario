...
[eval exp="f.STR_MAX = 30 , f.POW_MAX=30, f.SPD_MAX = 30, f.MOVE_MAX = 10"]
[eval exp="f.CURSE=0, f.ERO=0"]
[eval exp="f.ANAL = 50, f.VGNA = 100, f.BUST = 50"]
[eval exp="f.poison=0, f.slowly=0, f.excite=0, f.closed=0"]
[eval exp="f.boob=0, f.mazo=0, f.bags=0, f.slave=0, f.tatoo=0"]
[eval exp="f.date = 1"]
