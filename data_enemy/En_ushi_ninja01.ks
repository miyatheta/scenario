...
あんっ！！もっと、してぇ…[p]
#
鈴耶は甘い声で下忍にしなだれかかった[p]
#下忍
まったくだらしのない乳だな！！[p]
よかろう！拙者がここで躾けてやろう！！[p]
#
下忍は鈴耶の反応に相好を崩した[p]
房中術の効果で下忍のステータスが低下した[p]
[eval exp="f.En_Raptured += 1"]
[jump target="*fase2"]
[s]
;-----------------------------------------
...
;段階４
#
下忍はしっかりと鈴耶の腰を抱え込むと激しく腰を打ち付けた[p]
[eval exp="tf.fuck = f.EN_SEX "]
[call storage="routin/Rt_kaikan.ks" target="*VGNA"]
[call storage="asset_extra_reaction.ks" target="*orgasm"]
;リアクション
...
う？おおおおおおおお！？[p]
#
さらなる雄汁を催促するような締め上げに下忍の肉棒が快感に悲鳴を上げる[p]
#鈴耶
「忍法・筒枯らし！！」
#
精どころか魂も魄も吸い上げるような壮絶な吸い上げに下忍は[p]
[call storage="routin/Rt_bochu.ks"]
[if exp="f.EN_SAN <= 0"]
#下忍
ぐおおおおおおおおおっ！！！！[p]
...
ぐおおおおおおおおおっ！！！！[p]
#
絶叫とともに下忍は鈴耶を突き飛ばすようにして無理やり肉棒を引き抜いた[p]
#鈴耶
あら、残念[p]
#
...
#
下忍はニヤリとほくそ笑むと鈴耶を担ぎ上げて意気揚々と闇の中へ消えていった[p]
ゲームオーバー（実際には下忍の住処へ続きます）
[s]
