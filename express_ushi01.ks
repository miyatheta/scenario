...
[eval exp="f.Lv = 20, f.EN_STR = 10, f.en_DEX = 32, f.GRB=80, f.en_HP = 120 , f.type = 1, f.Round = 0"]
...
[eval exp="f.Lv = 30, f.EN_STR = 10, f.en_DEX=22, f.GRB=90, f.SEX=100 , f.en_HP = 160 , f.type = 1, f.Round = 0"]
...
[eval exp="f.Lv = 30, f.EN_STR = 10, f.en_DEX=25, f.GRB=110, f.SEX=120, f.en_HP = 250 , f.type = 1, f.Round = 0"]
...
[eval exp="f.Lv = 30, f.EN_STR = 10, f.en_DEX=28, f.GRB=100, f.SEX=150 , f.en_HP = 190 , f.type = 1, f.Round = 0"]
